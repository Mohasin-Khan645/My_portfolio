(() => {
  ...
  const CASE_STUDIES = {
    ...
    communication : {
      meta: "DevOps • Real Time Communication",
      title: "Real-Time Communication",
      problem: "Teams require secure, low-latency communication and collaboration tools that support video meetings, file sharing, and live interaction in real time.",
      approach: [
        "Built a multi-user video conferencing system using WebRTC.",
        "Implemented real-time signaling and messaging with Socket.io.",
        "Integrated screen sharing and collaborative whiteboard features.",
        "Added secure authentication and encrypted communication handling.",
        "Structured backend services for scalability and session management.",
      ],
      results: ["Smooth low-latency real-time communication",
                "Secure and scalable collaboration platform",
                "Improved understanding of WebRTC and media streaming",
                "Hands-on experience with real-time architecture and backend security",
  ],
      stack: ["WebRTC", "Sockt.io", "Node.js", "React", "MongoDB", "JWT Auth"],
    },
  };
